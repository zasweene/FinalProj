...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_QORVO_DWM3000_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_BUFFER_SIZE, 6144);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_QORVO_DWM3000, 1);
